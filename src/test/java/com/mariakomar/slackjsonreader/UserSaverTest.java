...
import com.mariakomar.slackjsonreader.saver.*;
...
public class UserSaverTest {
    ...
    @Before
    public void beforeEachTest() throws SaverException {
        ...
        when(mappingService.readJsonArrayWithObjectMapper()).thenReturn(messages);
